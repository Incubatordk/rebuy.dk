...
var I18N = (function () {
  ...
  var translations = {
    da: {
      ...
      // Structured-data strings. These mirror literals inside the JSON-LD
      // @graph in index.html so scripts/build-en.js can emit an English
      // version of the schema. Keep them in sync with that block.
      "schema.app.feature1": "Lokal markedsplads for brugt børnetøj og babyudstyr",
      "schema.app.feature2": "Chat med sælger direkte i appen",
      "schema.app.feature3": "Tag billede og opret annonce på sekunder",
      "schema.app.feature4": "Find annoncer i dit nærområde",
      "schema.app.feature5": "Favoritter og notifikationer",
      "schema.howto.buy.name": "Sådan køber du på Rebuy",
      "schema.howto.buy.desc": "Find brugt børnetøj og babyudstyr i dit nærområde i tre trin.",
      "schema.howto.sell.name": "Sådan sælger du på Rebuy",
      "schema.howto.sell.desc": "Sælg det, dine børn er vokset fra, i tre trin.",
      "schema.og.imageAlt": "Rebuy — Køb og sælg brugt børnetøj og babyudstyr lokalt",
      ...
      "showcase.feed.alt": "Rebuy app — find brugt børnetøj i nærheden med pris og afstand",
      "showcase.detail.title": "Se alle detaljer",
      "showcase.detail.text": "Pris, stand, billeder og afstand — samlet ét sted.",
      "showcase.detail.alt": "Rebuy app — annonce for brugt børnetøj med pris, stand og billeder",
      "showcase.messages.title": "Chat med sælger",
      "showcase.messages.text": "Aftal pris og afhentning direkte i appen.",
      "showcase.messages.alt": "Rebuy app — chat med sælger om pris og afhentning af babyudstyr",
      "showcase.post.title": "Sælg på få sekunder",
      "showcase.post.text": "Tag et billede, sæt en pris, og du er online.",
      "showcase.post.alt": "Rebuy app — opret annonce og sælg brugt børnetøj på få sekunder",
      ...
      "showcase.profile.alt": "Rebuy app — overblik over dine annoncer, favoritter og salg af genbrug",
      ...
      // Avoid fraud page (rebuy.dk/avoid-fraud)
      "fraud.title": "Undgå svindel",
      "fraud.updated": "Sidst opdateret: 15. juni 2026",
      "fraud.intro": "På Rebuy handler familier direkte med hinanden — lokalt og ansigt til ansigt. Det gør det både trygt og nemt, men ligesom alle andre steder online findes der svindlere, der forsøger at narre dig. Denne side hjælper dig med at genkende svindel og handle sikkert.",
      "fraud.s1_title": "Rebuy beder dig aldrig om …",
      "fraud.s1_intro": "Vær på vagt, hvis nogen udgiver sig for at være fra Rebuy. Vi vil aldrig:",
      "fraud.s1_li1": "Sende dig links til betaling, pengeoverførsel, MobilePay eller \"sikker handel\".",
      "fraud.s1_li2": "Bede om din adgangskode, dit kortnummer, din NemID/MitID eller koder fra din bank.",
      "fraud.s1_li3": "Bede dig flytte samtalen til SMS, e-mail, WhatsApp eller andre platforme.",
      "fraud.s1_li4": "Tage imod eller håndtere betalinger på vegne af købere og sælgere — Rebuy formidler kun kontakten.",
      "fraud.s2_title": "Sådan handler du trygt",
      "fraud.s2_intro": "De fleste handler på Rebuy går helt som de skal. Følg disse enkle råd, så er du godt sikret:",
      "fraud.s2_li1": "Mød op personligt. Rebuy er lavet til lokale handler ansigt til ansigt — se varen, før du betaler.",
      "fraud.s2_li2": "Betal først, når du står med varen. Brug kontant eller MobilePay direkte til sælgeren ved overdragelsen.",
      "fraud.s2_li3": "Hold al kommunikation i Rebuy-chatten. Så har vi mulighed for at hjælpe, hvis noget går galt.",
      "fraud.s2_li4": "Send aldrig penge på forhånd for fragt eller \"reservation\" — Rebuy handler om lokale, fysiske møder, ikke forsendelse.",
      "fraud.s2_li5": "Mødes et trygt sted, gerne om dagen og et offentligt sted, eller tag en ven eller familie med.",
      "fraud.s2_li6": "Stol på din mavefornemmelse. Lyder en handel for god til at være sand, er den det ofte.",
      "fraud.s3_title": "Typiske svindelnumre",
      "fraud.s3_intro": "Kender du de mest almindelige tricks, er de nemme at gennemskue:",
      "fraud.s3_li1": "Fragt-svindel: \"Køberen\" tilbyder at sende en kurer eller fragtmand og beder dig betale et gebyr eller bekræfte via et link. Rebuy bruger ikke fragt — afslå og mødes lokalt.",
      "fraud.s3_li2": "Falske betalingslinks: Du får en SMS eller besked med et link til at \"modtage\" eller \"frigive\" din betaling. Klik aldrig — bankerne og MobilePay sender ikke den slags links.",
      "fraud.s3_li3": "Overbetaling: Nogen \"betaler\" for meget og beder dig sende differencen tilbage. Den oprindelige betaling er falsk, og du står tilbage med tabet.",
      "fraud.s3_li4": "Flyt-væk-fra-appen: Svindlere vil hurtigt over på SMS, e-mail eller WhatsApp, hvor de ikke kan spores eller blokeres.",
      "fraud.s3_li5": "Hastværk og pres: \"Jeg har mange interesserede\" eller \"du skal betale nu\". Tag dig altid tid til at tjekke handlen igennem.",
      "fraud.s4_title": "Pas på falske beskeder",
      "fraud.s4_p": "Svindlere udgiver sig nogle gange for at være Rebuy i SMS'er eller e-mails — ofte med stavefejl, manglende æ, ø og å, eller en afsender, der minder om, men ikke er, \"Rebuy\". Officielle beskeder fra Rebuy får du i appen. Er du i tvivl om en besked, så åbn appen i stedet for at klikke på links, og kontakt os på support@rebuy.dk.",
      "fraud.s5_title": "Genkend en falsk profil",
      "fraud.s5_intro": "Tegn på en profil, du bør være ekstra forsigtig med:",
      "fraud.s5_li1": "Helt ny profil uden billede eller historik.",
      "fraud.s5_li2": "Vil kun kommunikere uden for appen.",
      "fraud.s5_li3": "Nægter at mødes personligt og insisterer på fragt eller forudbetaling.",
      "fraud.s5_li4": "Priser, der er urealistisk lave i forhold til varen.",
      "fraud.s6_title": "Anmeld og bloker",
      "fraud.s6_p": "Oplever du en mistænkelig bruger eller annonce, så brug \"Anmeld\"- og \"Bloker\"-funktionerne inde i appen, eller skriv til os på support@rebuy.dk. Vi undersøger alle anmeldelser og fjerner brugere, der svindler. Tror du, at du er blevet snydt for penge, så kontakt din bank med det samme og anmeld det til politiet på politi.dk.",
      "fraud.s7_title": "Mere hjælp",
      "fraud.s7_intro": "Vil du vide mere om at færdes sikkert online, kan du finde gode råd her:",
      "fraud.s7_li1": "sikkerdigital.dk — myndighedernes samlede vejledning om digital sikkerhed.",
    ...
    en: {
      ...
      // Structured-data strings — English mirror of the schema.* block in the
      // Danish dictionary. Consumed by scripts/build-en.js.
      "schema.app.feature1": "Local marketplace for used kids' clothes and baby gear",
      "schema.app.feature2": "Chat with the seller directly in the app",
      "schema.app.feature3": "Snap a photo and post a listing in seconds",
      "schema.app.feature4": "Find listings in your local area",
      "schema.app.feature5": "Favourites and notifications",
      "schema.howto.buy.name": "How to buy on Rebuy",
      "schema.howto.buy.desc": "Find used kids' clothes and baby gear in your local area in three steps.",
      "schema.howto.sell.name": "How to sell on Rebuy",
      "schema.howto.sell.desc": "Sell what your kids have outgrown in three steps.",
      "schema.og.imageAlt": "Rebuy — Buy and sell used kids' clothes and baby gear locally",
      ...
      "showcase.feed.alt": "Rebuy app — find secondhand kids' clothes nearby with price and distance",
      "showcase.detail.title": "See every detail",
      "showcase.detail.text": "Price, condition, photos and distance — all in one place.",
      "showcase.detail.alt": "Rebuy app — listing for used kids' clothes with price, condition and photos",
      "showcase.messages.title": "Chat with the seller",
      "showcase.messages.text": "Agree on price and pick-up directly in the app.",
      "showcase.messages.alt": "Rebuy app — chat with the seller about price and pick-up of baby gear",
      "showcase.post.title": "Sell in seconds",
      "showcase.post.text": "Snap a photo, set a price, and you're live.",
      "showcase.post.alt": "Rebuy app — create a listing and sell used kids' clothes in seconds",
      "showcase.profile.title": "Stay on top of it all",
      "showcase.profile.text": "Your listings, favourites and settings, neatly together.",
      "showcase.profile.alt": "Rebuy app — overview of your listings, favourites and secondhand sales",
      ...
      // Avoid fraud page (rebuy.dk/avoid-fraud)
      "fraud.title": "Avoid fraud",
      "fraud.updated": "Last updated: 15 June 2026",
      "fraud.intro": "On Rebuy, families trade directly with each other — locally and face to face. That makes it both safe and easy, but just like anywhere else online, there are scammers who try to trick you. This page helps you recognise fraud and trade safely.",
      "fraud.s1_title": "Rebuy will never ask you to …",
      "fraud.s1_intro": "Be on your guard if someone claims to be from Rebuy. We will never:",
      "fraud.s1_li1": "Send you links for payment, money transfers, MobilePay, or \"secure trade\".",
      "fraud.s1_li2": "Ask for your password, card number, NemID/MitID, or codes from your bank.",
      "fraud.s1_li3": "Ask you to move the conversation to SMS, email, WhatsApp, or other platforms.",
      "fraud.s1_li4": "Receive or handle payments on behalf of buyers and sellers — Rebuy only connects you.",
      "fraud.s2_title": "How to trade safely",
      "fraud.s2_intro": "Most trades on Rebuy go exactly as they should. Follow these simple tips and you're well protected:",
      "fraud.s2_li1": "Meet in person. Rebuy is built for local, face-to-face trades — see the item before you pay.",
      "fraud.s2_li2": "Only pay once the item is in your hands. Use cash or MobilePay directly to the seller at handover.",
      "fraud.s2_li3": "Keep all communication in the Rebuy chat. That way we can help if something goes wrong.",
      "fraud.s2_li4": "Never send money up front for shipping or a \"reservation\" — Rebuy is about local, in-person meetups, not delivery.",
      "fraud.s2_li5": "Meet somewhere safe, preferably during the day and in a public place, or bring a friend or family member.",
      "fraud.s2_li6": "Trust your gut. If a deal sounds too good to be true, it usually is.",
      "fraud.s3_title": "Common scams",
      "fraud.s3_intro": "Once you know the most common tricks, they're easy to spot:",
      "fraud.s3_li1": "Shipping scam: the \"buyer\" offers to send a courier and asks you to pay a fee or confirm via a link. Rebuy doesn't use shipping — decline and meet locally.",
      "fraud.s3_li2": "Fake payment links: you get an SMS or message with a link to \"receive\" or \"release\" your payment. Never click — banks and MobilePay don't send links like that.",
      "fraud.s3_li3": "Overpayment: someone \"pays\" too much and asks you to send the difference back. The original payment is fake, and you're left with the loss.",
      "fraud.s3_li4": "Move-off-the-app: scammers want to switch to SMS, email, or WhatsApp quickly, where they can't be tracked or blocked.",
      "fraud.s3_li5": "Urgency and pressure: \"I have lots of people interested\" or \"you have to pay now\". Always take your time to check the deal.",
      "fraud.s4_title": "Watch out for fake messages",
      "fraud.s4_p": "Scammers sometimes pose as Rebuy in texts or emails — often with spelling mistakes, missing Danish characters (æ, ø, å), or a sender that looks like, but isn't, \"Rebuy\". Official messages from Rebuy reach you inside the app. If you're unsure about a message, open the app instead of clicking links, and contact us at support@rebuy.dk.",
      "fraud.s5_title": "Spot a fake profile",
      "fraud.s5_intro": "Signs of a profile you should be extra careful with:",
      "fraud.s5_li1": "A brand-new profile with no photo or history.",
      "fraud.s5_li2": "Only wants to communicate outside the app.",
      "fraud.s5_li3": "Refuses to meet in person and insists on shipping or prepayment.",
      "fraud.s5_li4": "Prices that are unrealistically low for the item.",
      "fraud.s6_title": "Report and block",
      "fraud.s6_p": "If you come across a suspicious user or listing, use the \"Report\" and \"Block\" features inside the app, or write to us at support@rebuy.dk. We look into every report and remove users who scam. If you think you've been cheated out of money, contact your bank immediately and report it to the police at politi.dk.",
      "fraud.s7_title": "More help",
      "fraud.s7_intro": "If you want to learn more about staying safe online, you'll find good advice here:",
      "fraud.s7_li1": "sikkerdigital.dk — the Danish authorities' central guidance on digital security.",
  ...
  function detect() {
    // 0. Pages that exist at their own per-language URL pin the language with
    //    data-lang-locked (currently /en/, generated by scripts/build-en.js).
    //    Without this, a visitor whose stored preference or browser locale is
    //    Danish would land on /en/ from search and have it swapped to Danish —
    //    English content at an English URL, replaced client-side. See #97.
    var locked = document.documentElement.getAttribute("data-lang-locked");
    if (locked && SUPPORTED.indexOf(locked) !== -1) return locked;
  ...
  // Persist a language choice without touching the DOM. Used when the toggle
  // navigates to a sibling URL instead of swapping in place (#97), so the
  // destination page honours the choice on arrival.
  function remember(lang) {
    if (SUPPORTED.indexOf(lang) === -1) return;
    try {
      localStorage.setItem(STORAGE_KEY, lang);
    } catch (e) {
      // Private mode / storage disabled — the navigation still works.
    }
  }
