...
var I18N = (function () {
  ...
  var translations = {
    da: {
      ...
      "privacy.s5_p": "Vi opbevarer dine personoplysninger, så længe din konto er aktiv. Du kan til enhver tid slette din konto inde i appen via Profil → Slet konto. Når du sletter din konto, fjerner vi dine personoplysninger inden for 30 dage, medmindre lovgivningen kræver længere opbevaring (f.eks. bogføringsloven).",
    ...
    en: {
      ...
      "privacy.s5_p": "We retain your personal data for as long as your account is active. You can delete your account at any time from inside the app under Profile → Delete account. When you delete your account, we remove your personal data within 30 days, unless the law requires longer retention (e.g. Danish bookkeeping law).",
