...
function keyPages(i18n, mode) {
  ...
  return [
    ...
    {
      // The site's default language is Danish; /en/ is the English rendering of
      // the same homepage, generated by scripts/build-en.js (#97). Naming it
      // here means an English-language agent has a URL to cite in English.
      title: 'Home (English)',
      url: `${SITE_URL}/en/`,
      description: 'The same homepage in English — what Rebuy is, what you can buy and sell, app screenshots, download links, and the FAQ.',
    },
    {
      title: 'Blog',
      url: `${SITE_URL}/blog/`,
